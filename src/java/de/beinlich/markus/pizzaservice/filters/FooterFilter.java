package de.beinlich.markus.pizzaservice.filters;
...
public class FooterFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("FooterFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("FooterFilter:DoAfterProcessing");
        }
	...
	for (Enumeration en = request.getParameterNames(); en.hasMoreElements(); ) {
        ...
        PrintWriter respOut = new PrintWriter(response.getWriter());
        respOut.println("<p><strong>This has been appended by an intrusive filter.</strong></p>");
        Set<String> hitCounter = (HashSet) request.getServletContext().getAttribute("hitCounter");
        if (hitCounter == null) {
            hitCounter = new HashSet<>();
            request.getServletContext().setAttribute("hitCounter", hitCounter);
        }
        hitCounter.add(request.getSession().getId());

        respOut.print("Visits: " + hitCounter.size() + " - " + hitCounter);
    }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FooterFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("FooterFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FooterFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FooterFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FooterFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FooterFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FooterFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
